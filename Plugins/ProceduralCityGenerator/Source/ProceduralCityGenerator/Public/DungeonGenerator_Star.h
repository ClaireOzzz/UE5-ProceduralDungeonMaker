...
#include "DungeonGenerator_Star.generated.h"

/**
 * 
 */
UCLASS()
class PROCEDURALCITYGENERATOR_API ADungeonGenerator_Star : public ADungeonGenerator_GridBased
{
	GENERATED_BODY()

public:
	UPROPERTY(EditAnywhere, Category = "Dungeon Settings")
	ACityGen_RoomBase* CentralRoom;
